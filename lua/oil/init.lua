...
---@alias oil.HlRange { [1]: "hl_range", [2]: string, [3]: integer, [4]: integer } A tuple of highlight group name, col_start, col_end
---@alias oil.HlTuple { [1]: "hl_tuple", [2]: string, [3]: string } A tuple of text, highlight group
---@alias oil.HlRangeTuple { [1]: "hl_range_tuple", [2]: string, [3]: oil.HlRange[] } A tuple of text, internal highlights
---@alias oil.Extmark { [1]: "extmark", [2]: table }
---@alias oil.TextChunk string|oil.HlTuple|oil.HlRangeTuple|oil.Extmark
